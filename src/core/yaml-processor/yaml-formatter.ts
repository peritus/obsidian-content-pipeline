...
export class YamlFormatter {
    ...
    private formatRoutingInfo(routingInfo: StepRoutingInfo): string {
        const lines = [
            ...
            '',
            '---',
            'filename: Secondary Topic.md',
            'nextStep: step_id_2',
            '---',
            'Second document content...',
            '',
            'Choose descriptive filenames based on the actual content topic.',
            'Examples: "Recipe Notes.md", "Meeting Summary.md", "Project Ideas.md", "Personal Thoughts.md"',
            '',
